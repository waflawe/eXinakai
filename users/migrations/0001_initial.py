    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Электронная почта для аккаунта.', max_length=254, unique=True, verbose_name='Почта')),
                ...
                ('is_2fa_enabled', models.BooleanField(default=False, verbose_name='Включена ли 2FA')),
            ],
            options={
