# Generated by Django 5.0.4 on 2024-09-12 14:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Коллекция', to='exinakai.passwordscollection', verbose_name='Коллекция')),
            ],
            options={
                'verbose_name': 'Пароль',
